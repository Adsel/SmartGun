...
returns it. The return value is broadcast to all subscribers of `/topic/simulation`, as
...
connections. Upon a successful connection, the client subscribes to the `/topic/simulation`
